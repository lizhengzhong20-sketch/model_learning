...
[![交互式知识树 · 力导向动态图](assets/knowledge-tree.png)](playground/knowledge-tree.html)

> 🖱️ **点击上图打开可交互版本**：节点可拖拽甩动回弹、悬停聚焦上下游链路、滚轮缩放、按篇筛选、搜索定位；小节点是横跨多章的关键概念（向量 / 注意力 / 双塔 / RLHF / Diffusion…），点击章节点直达页面清单。克隆仓库后也可本地双击 `playground/knowledge-tree.html` 打开，无需安装任何东西。
