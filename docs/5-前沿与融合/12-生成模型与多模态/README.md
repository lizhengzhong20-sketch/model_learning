...
| 6 | [进阶专题-生成模型前沿](./06-进阶专题-生成模型前沿.md) | ⭐⭐⭐⭐ | Flow Matching / Rectified Flow（与 DDPM 的概率流统一）、一致性模型与少步蒸馏、DiT 骨干换代、视频生成、自回归 vs 扩散之争、三个开放问题 |
| 7 | [语音与音频](./07-语音与音频.md) | ⭐⭐⭐ | 波形→采样→梅尔频谱（感知线性的数学深潜）、ASR 从三级流水线到 CTC 与 Whisper、TTS 两段式与端到端、音频 token 化与 LLM 合流、WER 与下游对齐 |
| 8 | [可信AI](./08-可信AI.md) | ⭐⭐⭐⭐ | 跨章专题收束：对抗样本（FGSM 线性解释深潜）、公平性不可能定理算例、差分隐私（ε 上限承诺深潜）、联邦学习梯度泄露、分布偏移的因果视角 |
